...
const nl: Translation = {
  ...
  WIREGUARD: 'WireGuard',
  WIREGUARD_ENABLE: 'WireGuard inschakelen',
  WIREGUARD_ENDPOINT: 'Endpoint',
    WIREGUARD_PORT: 'Poort',
    WIREGUARD_PRIVATE_KEY: 'Privésleutel',
    WIREGUARD_PEER_PUBLIC_KEY: 'Peer publieke sleutel',
    WIREGUARD_ADDRESS: 'Adres',
    WIREGUARD_NETMASK: 'Netmasker',
