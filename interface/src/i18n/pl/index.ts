...
const pl: BaseTranslation = {
  ...
  WIREGUARD: 'WireGuard',
  WIREGUARD_ENABLE: 'Włącz WireGuard',
  WIREGUARD_ENDPOINT: 'Adres endpoint',
  WIREGUARD_PORT: 'Port',
  WIREGUARD_PRIVATE_KEY: 'Klucz prywatny',
  WIREGUARD_PEER_PUBLIC_KEY: 'Klucz publiczny peera',
  WIREGUARD_ADDRESS: 'Adres',
  WIREGUARD_NETMASK: 'Maska',
