...
EMS-ESP includes an optional WireGuard client. Configure your endpoint, port and keys on the Network settings page of the web interface. Once enabled, the tunnel starts after WiFi connects and automatically reconnects if the connection drops.
